...
public class KThread {
	...
	public KThread() {
		if (currentThread != null) {
			tcb = new TCB();
			isCompleted = new Condition2(lockJoin);
		}	    
		else {
	...
	/**
	 * Get the status of this thread. This is used for Condition2
	 *
	...
	public static void finish() {
		...
		lockJoin.acquire();
		KThread thread = currentThread.joinQ.nextThread();
		while(thread != null){
			currentThread.joinQ.acquire(thread);
			thread = currentThread.joinQ.nextThread();
		}
		currentThread.isCompleted.wakeAll();
		currentThread.joinQ = null;
		lockJoin.release();
	...
	private Condition2 isCompleted;
	private static Lock lockJoin = new Lock();
